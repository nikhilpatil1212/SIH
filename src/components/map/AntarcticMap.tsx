...
export function AntarcticMap({ onNavigate }: { onNavigate?: (target: "iceberg" | "routes") => void }) {
  ...
  return (
    <div className="relative h-full w-full flex flex-col">
      ...
      <div className="absolute left-14 top-2.5 z-20 hidden md:flex items-center gap-2 rounded-md border border-[#1d445c]/80 bg-[#071521]/90 light:border-[#d8d0c2] light:bg-[#ffffff]/90 px-2 py-1 backdrop-blur shadow-md">
        <span className="font-mono text-[10px] font-semibold uppercase tracking-wider text-[#91aeb9] light:text-[#5a7686]">
          Horizon:
        </span>
